...
impl UsageLimits {
    pub fn monthly_limit(&self) -> u32 {
        self.monthly_limit.unwrap_or(200)
    }
    pub fn doctor_limit(&self) -> u32 {
        self.doctor_limit.unwrap_or(75)
    }
    pub fn git_limit(&self) -> u32 {
        self.git_limit.unwrap_or(60)
    }
    pub fn forensic_limit(&self) -> u32 {
        self.forensic_limit.unwrap_or(50)
    }
    pub fn mock_limit(&self) -> u32 {
        self.mock_limit.unwrap_or(30)
    }
    pub fn cloud_limit(&self) -> u32 {
        self.cloud_limit.unwrap_or(3)
    }
    pub fn warn_at_percent(&self) -> u32 {
        self.warn_at_percent.unwrap_or(80)
    }
}
